...
class SolicitudsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create solicitud" do
    assert_difference('Solicitud.count') do
      post solicituds_url, params: { solicitud: { cliente_contacto_id: @solicitud.cliente_contacto_id, cliente_id: @solicitud.cliente_id, comentarios: @solicitud.comentarios, estatus: @solicitud.estatus, proyecto: @solicitud.proyecto, user_id: @solicitud.user_id } }
    end
  ...
  test "should update solicitud" do
    patch solicitud_url(@solicitud), params: { solicitud: { cliente_contacto_id: @solicitud.cliente_contacto_id, cliente_id: @solicitud.cliente_id, comentarios: @solicitud.comentarios, estatus: @solicitud.estatus, proyecto: @solicitud.proyecto, user_id: @solicitud.user_id } }
