...
class ProyectosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proyecto" do
    assert_difference('Proyecto.count') do
      post proyectos_url, params: { proyecto: { comentarios: @proyecto.comentarios, empresa: @proyecto.empresa, nombre_proyecto: @proyecto.nombre_proyecto, responsable: @proyecto.responsable } }
    end
  ...
  test "should update proyecto" do
    patch proyecto_url(@proyecto), params: { proyecto: { comentarios: @proyecto.comentarios, empresa: @proyecto.empresa, nombre_proyecto: @proyecto.nombre_proyecto, responsable: @proyecto.responsable } }
