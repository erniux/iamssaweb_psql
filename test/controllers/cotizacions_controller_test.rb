...
class CotizacionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cotizacion" do
    assert_difference('Cotizacion.count') do
      post cotizacions_url, params: { cotizacion: { cliente_id: @cotizacion.cliente_id, num_cotizacion: @cotizacion.num_cotizacion, proyecto_id: @cotizacion.proyecto_id, solicitud_id: @cotizacion.solicitud_id } }
    end
  ...
  test "should update cotizacion" do
    patch cotizacion_url(@cotizacion), params: { cotizacion: { cliente_id: @cotizacion.cliente_id, num_cotizacion: @cotizacion.num_cotizacion, proyecto_id: @cotizacion.proyecto_id, solicitud_id: @cotizacion.solicitud_id } }
