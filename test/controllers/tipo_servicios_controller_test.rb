...
class TipoServiciosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tipo_servicio" do
    assert_difference('TipoServicio.count') do
      post tipo_servicios_url, params: { tipo_servicio: { cve_tipo_servicio: @tipo_servicio.cve_tipo_servicio, detalle_servicio: @tipo_servicio.detalle_servicio } }
    end
  ...
  test "should update tipo_servicio" do
    patch tipo_servicio_url(@tipo_servicio), params: { tipo_servicio: { cve_tipo_servicio: @tipo_servicio.cve_tipo_servicio, detalle_servicio: @tipo_servicio.detalle_servicio } }
